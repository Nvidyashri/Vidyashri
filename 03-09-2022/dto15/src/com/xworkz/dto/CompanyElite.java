...
public class CompanyElite {
	...
	public static void main(String[] args) {
		...
		dto.setFourthManagerName("adhi");
		dto.setLocation("Banglore");
		dto.setMainManagerName("vijay");
		...
		dto.setSecondaryManagerName("vishal");

		dto.setTablesColors("Yellow");
		dto.setThirdManagerName("ajay");
		...
		dto1.setFourthManagerName("adhi");
		dto1.setLocation("Banglore");
		dto1.setMainManagerName("vijay");
		...
		dto1.setSecondaryManagerName("Visha");

		dto1.setTablesColors("Yellow");
		dto1.setThirdManagerName("ajay");
